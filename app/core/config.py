...
class Settings(BaseSettings):
    ...
    dhan_token_refresh_margin_seconds: int = 1800
    kite_client_id: str | None = None
    ...
    live_dhan_option_summary_batch_size: int = 25
    live_dhan_option_summary_batch_delay_seconds: float = 3.0
