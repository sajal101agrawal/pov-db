...
def _live_forward_metrics(option_summary: dict[str, Any], trade_date: date) -> dict[str, Any]:
    ...
    metrics: dict[str, Any] = {
        ...
        "put_iv_60": put_iv60,
        "put_iv_90": put_iv90,
        "nearest_ce_iv": call_iv30,
        "nearest_pe_iv": put_iv30,
        "nearest_ce_ltp": _coerce_float(option_summary.get("live_atm_call_ltp")),
        "nearest_pe_ltp": _coerce_float(option_summary.get("live_atm_put_ltp")),
