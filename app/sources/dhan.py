    ...
    primary["live_iv_terms"] = [
        {
            ...
            "preferred_strike": item.get("live_atm_preferred_strike"),
            "same_strike_used": item.get("live_atm_same_strike_used"),
            "strike_source": item.get("live_atm_strike_source"),
            "atm_iv": item.get("live_atm_iv"),
            "call_iv": item.get("live_atm_call_iv"),
            "put_iv": item.get("live_atm_put_iv"),
            "call_bid_price": item.get("live_atm_call_bid_price"),
            "call_ask_price": item.get("live_atm_call_ask_price"),
            "put_bid_price": item.get("live_atm_put_bid_price"),
            "put_ask_price": item.get("live_atm_put_ask_price"),
            "call_bid_ask_spread_pct": item.get("live_atm_call_bid_ask_spread_pct"),
            "put_bid_ask_spread_pct": item.get("live_atm_put_bid_ask_spread_pct"),
