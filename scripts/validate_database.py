...
RANGE_CHECKS = {
    ...
    "symbol_daily_metrics.vol_range": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE iv_30 < 0 OR iv_30 > 5 OR iv_60 < 0 OR iv_60 > 5 OR iv_90 < 0 OR iv_90 > 5 OR call_iv_30 < 0 OR call_iv_30 > 5 OR call_iv_60 < 0 OR call_iv_60 > 5 OR call_iv_90 < 0 OR call_iv_90 > 5 OR put_iv_30 < 0 OR put_iv_30 > 5 OR put_iv_60 < 0 OR put_iv_60 > 5 OR put_iv_90 < 0 OR put_iv_90 > 5 OR rv_10 < 0 OR rv_10 > 5 OR rv_20 < 0 OR rv_20 > 5 OR rv_30 < 0 OR rv_30 > 5 OR rv_60 < 0 OR rv_60 > 5 OR rv_90 < 0 OR rv_90 > 5",
    ...
    "symbol_daily_metrics.option_volume_60d_range": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE option_volume_60d < 0",
    "symbol_daily_metrics.percentile_range": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE iv_30_percentile < 0 OR iv_30_percentile > 100 OR iv_60_percentile < 0 OR iv_60_percentile > 100 OR iv_90_percentile < 0 OR iv_90_percentile > 100 OR call_iv_30_percentile < 0 OR call_iv_30_percentile > 100 OR call_iv_60_percentile < 0 OR call_iv_60_percentile > 100 OR put_iv_30_percentile < 0 OR put_iv_30_percentile > 100 OR put_iv_60_percentile < 0 OR put_iv_60_percentile > 100 OR call_fwdfct_3060_percentile < 0 OR call_fwdfct_3060_percentile > 100 OR put_fwdfct_3060_percentile < 0 OR put_fwdfct_3060_percentile > 100 OR call_slope_3060_percentile < 0 OR call_slope_3060_percentile > 100 OR put_slope_3060_percentile < 0 OR put_slope_3060_percentile > 100 OR vrp_percentile < 0 OR vrp_percentile > 100 OR skew_percentile < 0 OR skew_percentile > 100",
    ...
    "symbol_daily_metrics.call_forward_factor_formula": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE call_fwdfct_3060 IS NOT NULL AND ABS(call_fwdfct_3060 - ((call_iv_30 / NULLIF(SQRT((POWER(call_iv_60, 2) * dte_60 - POWER(call_iv_30, 2) * dte_30) / NULLIF(dte_60 - dte_30, 0)), 0)) - 1.0)) > 0.0001",
    "symbol_daily_metrics.put_forward_factor_formula": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE put_fwdfct_3060 IS NOT NULL AND ABS(put_fwdfct_3060 - ((put_iv_30 / NULLIF(SQRT((POWER(put_iv_60, 2) * dte_60 - POWER(put_iv_30, 2) * dte_30) / NULLIF(dte_60 - dte_30, 0)), 0)) - 1.0)) > 0.0001",
    "symbol_daily_metrics.call_slope_formula": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE call_slope_3060 IS NOT NULL AND ABS(call_slope_3060 - ((call_iv_60 - call_iv_30) / NULLIF(dte_60 - dte_30, 0))) > 0.0001",
    "symbol_daily_metrics.put_slope_formula": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE put_slope_3060 IS NOT NULL AND ABS(put_slope_3060 - ((put_iv_60 - put_iv_30) / NULLIF(dte_60 - dte_30, 0))) > 0.0001",
