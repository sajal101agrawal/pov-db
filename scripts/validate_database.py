...
RANGE_CHECKS = {
    ...
    "symbol_daily_metrics.percentile_range": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE iv_30_percentile < 0 OR iv_30_percentile > 100 OR iv_60_percentile < 0 OR iv_60_percentile > 100 OR iv_90_percentile < 0 OR iv_90_percentile > 100 OR call_fwdfct_3060_percentile < 0 OR call_fwdfct_3060_percentile > 100 OR put_fwdfct_3060_percentile < 0 OR put_fwdfct_3060_percentile > 100 OR vrp_percentile < 0 OR vrp_percentile > 100 OR skew_percentile < 0 OR skew_percentile > 100",
