...
RANGE_CHECKS = {
    ...
    "symbol_daily_metrics.vol_range": "SELECT COUNT(*) FROM symbol_daily_metrics WHERE iv_30 < 0 OR iv_30 > 5 OR iv_60 < 0 OR iv_60 > 5 OR iv_90 < 0 OR iv_90 > 5 OR rv_10 < 0 OR rv_10 > 5 OR rv_20 < 0 OR rv_20 > 5 OR rv_30 < 0 OR rv_30 > 5",
...
DIAGNOSTIC_QUERIES = {
    ...
    "metrics.large_day_over_day_moves": """
        ...
        SELECT
            COUNT(*) FILTER (WHERE iv30_abs_change > 0.50) AS iv30_change_gt_50_vol_points,
            COUNT(*) FILTER (WHERE skew25_abs_change > 0.50) AS skew25_change_gt_50_vol_points,
            MAX(iv30_abs_change) AS max_iv30_abs_change,
            MAX(skew25_abs_change) AS max_skew25_abs_change
        FROM changes
    """,
